function Accueil() {
  return (
    <section id="accueil" aria-labelledby="titre-accueil">
      <h1 id="titre-accueil">David MOTTOLA - DEVELOPPEUR WEB</h1>
      <p>
        ...
        modernes, responsives et intuitives avec React, JavaScript et SCSS.
      </p>
