...
import MVG from "../assets/MVGExemple.webp";
  ...
  return (
    <section id="projets">
      ...
      <article>
        ...
        <p>
          Application fonctionnelle et responsive, affichage dynamique des
          logements et de leurs détails, navigation et page 404.
        </p>
        <h4>Perspectives d'amélioration</h4>
        <p>
          Ajout de filtres de recherche et amélioration de l'accessibilité,
          notamment clavier et focus.
        </p>
      </article>
      <article>
        ...
        <p>
          ...
          référencement et de notation de livres dont le front-end de
          l'application était déjà fourni.
        </p>
        <h4>Objectifs</h4>
        <p>
          ...
          d'ajouter, modifier, supprimer et noter des livres selon leurs
          autorisations.
        </p>
        <h4>Stack Technique</h4>
        <ul>
        ...
        <h4>Résultats et impact</h4>
        <p>
          API fonctionnelle permettant l'authentification des utilisateurs,
          l'ajout, la modification et la suppression de livres selon les
          autorisations, ainsi que leur notation avec calcul de la note moyenne.
        </p>
        <h4>Perspectives d'amélioration</h4>
        <p>
          Renforcer la gestion des erreurs et la sécurité de l'API, et ajouter
          des fonctionnalités de recherche et de filtrage des livres par auteur
          ou par genre.
        </p>
      </article>
    </section>
